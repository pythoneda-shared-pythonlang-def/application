...
#
# Copyright (C) 2023-today rydnr's pythoneda-shared-pythoneda-def/application
#
...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-artifact-shared = {
      ...
      url = "github:pythoneda-shared-artifact-def/shared/0.0.17";
    };
    pythoneda-shared-pythoneda-banner = {
      inputs.nixos.follows = "nixos";
      inputs.flake-utils.follows = "flake-utils";
    ...
    pythoneda-shared-pythoneda-infrastructure = {
      ...
      inputs.pythoneda-shared-pythoneda-domain.follows =
        "pythoneda-shared-pythoneda-domain";
      url = "github:pythoneda-shared-pythoneda-def/infrastructure/0.0.5";
    };
  };
  outputs = inputs:
    with inputs;
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "application";
        version = "0.0.26";
        sha256 = "13wrzhfffhlvlz6sdkl55dqiim5jacmr3wp92ljqx1pr33m03saf";
        pname = "${org}-${repo}";
