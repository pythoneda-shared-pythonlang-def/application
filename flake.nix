...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-artifact-shared = {
      ...
      url = "github:pythoneda-shared-artifact-def/shared/0.0.61";
    };
    pythoneda-shared-pythonlang-banner = {
      inputs.nixos.follows = "nixos";
      inputs.flake-utils.follows = "flake-utils";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "application";
        version = "0.0.48";
        sha256 = "1kfqyp71gfqi30h4h8hjv1a4a6z0zhv7zxgnk13vyid66a1h4gs7";
        pname = "${org}-${repo}";
        ...
        devShells = rec {
          ...
          pythoneda-shared-pythonlang-application-python38 =
            shared.devShell-for {
              ...
              package =
                packages.pythoneda-shared-pythonlang-application-python38;
